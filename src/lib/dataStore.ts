...
export const DEFAULT_SETTINGS: BusinessSettings = {
  ...
  operator_salary: 500000,
  collector_fee_per_user: 5000,
  marketing_fee_monthly: 50000,
...
export const DEFAULT_SUBSCRIBERS: Subscriber[] = [
  {
    id: 'sub-1',
    username_pppoe: 'user_test',
    pppoe_password: '123',
    full_name: 'Akun Tembong',
    package_id: 'pkg-5m',
    package_name: 'Paket Up to 5 Mbps',
  ...
  {
    id: 'sub-2',
    username_pppoe: 'user-test123',
    pppoe_password: '123',
    full_name: 'VERA (Fix Strip)',
    package_id: 'pkg-8m',
    package_name: 'Paket Up to 8 Mbps',
  ...
  {
    id: 'sub-4',
    username_pppoe: 'user-test1234',
    pppoe_password: '123',
    full_name: 'Acim (Fix Strip)',
    package_id: 'pkg-8m',
    package_name: 'Paket Up to 8 Mbps',
    package_price: 250000,
    installation_fee: 50000,
  ...
  {
    id: 'sub-5',
    username_pppoe: 'user-test12345',
    pppoe_password: '123',
    full_name: 'BuSupri (Fix Strip)',
    package_id: 'pkg-8m',
    package_name: 'Paket Up to 8 Mbps',
    package_price: 250000,
    installation_fee: 50000,
...
export const DEFAULT_EXPENSES: ExpenseTransaction[] = [
  ...
  },
  {
    ...
    amount: 50000,
    description: 'Komisi & insentif marketing rutin bulanan',
    fund_source: 'Kas Operasional',
  },
  {
    id: 'exp-5',
    ...
    amount: 55000,
    description: 'Jasa tagih iuran 11 user lunas x Rp 5.000',
    fund_source: 'Kas Operasional',
  },
  {
    id: 'exp-6',
